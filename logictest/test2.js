 ...
 */
 ...
 function counter(arr) {
    ...
    //for(var i kurang dari panjang dari array, i terus bertambah 1)
        if(counts[arr[i]]){ 
            //Check apabila dictionary key sama dengan key parameternya, apabila counts kosong maka key akan ditambah
            counts[arr[i]] += 1 
            //value pada key ditambah dengan 1
        }else{ 
            //Jika tidak
            counts[arr[i]] = 1 
            //value sama dengan 1
